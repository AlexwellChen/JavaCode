...
public class TestContact {
	...
	public static void main(String[] args) {
		...
		// Test accessors
		assertTrue("2: Testing method getWorkTelephone", contact.getWorkTelephone().equals(workTelephone));
		assertTrue("3: Testing method getJobPosition", contact.getJobPosition().equals(jobPosition));

		// Test method toString
		String result = name + "_" + homeTelephone + "_" + email + "_" + workTelephone + "_" + jobPosition;
		assertTrue("4: Testing method toString", contact.toString().equals(result));
