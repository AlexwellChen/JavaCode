...
public class TestIndividualCustomer {
	...
	public static void main(String[] args) {
		...
		IndividualCustomer individualCustomer = new IndividualCustomer(customerId, person);

		// Test class definition
		assertTrue("1: Testing class definition", individualCustomer instanceof Customer);

		// Test method getCustomerId
		assertTrue("2: Testing method getCustomerId", individualCustomer.getCustomerId().equals(customerId));

		// Test method getPerson
		assertTrue("3: Testing method getPerson", individualCustomer.getPerson().equals(person));
