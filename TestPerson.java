...
public class TestPerson {
	...
	public static void main(String[] args) {
		...
		assertTrue("3: Testing method getHomeTelephone", person.getHomeTelephone().equals(homeTelephone));
		assertTrue("4: Testing method getEmail", person.getEmail().equals(email));
		...
		try {
			assertTrue("8: Testing method equals", !personOne.equals(new Object()));
		...
		assertTrue("10: Testing method toString", person.toString().equals(result));
